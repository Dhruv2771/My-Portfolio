...
const projects = [
    {
        ...
        longDescription: "Built an advanced system leveraging collaborative and content-based filtering techniques. Applied A/B testing and optimized models natively in Python.",
        techStack: ["Python", "TensorFlow", "Scikit-learn", "Pandas"],
        repo: "https://github.com/DhruvKapatel/anomaly-detection",
        demo: "#",
    ...
    {
        id: "f1-pitstop-pro",
        title: "F1 PitStop Pro",
        category: "Predictive Analytics",
        description: "Predictive engine utilizing historical Formula 1 data.",
        longDescription: "Calculates optimized pit stop strategies for competitive advantage. The project aims to leverage historical F1 data to predict pit stop strategies, enhancing the decision-making process for teams.",
        techStack: ["Python", "Machine Learning", "Data Analytics"],
        repo: "https://github.com/DhruvKapatel/f1-pitstop-pro",
        demo: "#",
    ...
    },
    {
        ...
        description: "Intelligent web assistant featuring sentiment classification.",
        longDescription: "An intelligent web assistant featuring logistic regression sentiment classification and smart database integrations designed for modern e-commerce platforms. Achieved over 85% accuracy.",
        techStack: ["Python", "NLP", "React"],
        repo: "https://github.com/DhruvKapatel/ecommerce-chatbot",
        demo: "#",
    ...
    },
    {
        ...
        category: "LLMOps / Back-end",
        description: "Vector-based RAG architecture for querying internal knowledge bases.",
        longDescription: "A robust Retrieval-Augmented Generation (RAG) pipeline utilizing Pinecone and OpenAI embeddings. Deployed via FastAPI to serve semantic search queries across millions of PDF documents in under 200ms.",
        techStack: ["FastAPI", "Pinecone", "OpenAI API", "Docker", "LangChain"],
        repo: "#",
        demo: "#",
        ...
        mediaType: "image",
        mediaUrl: "https://images.pexels.com/photos/273153/pexels-photo-273153.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1",
        demoUrl: "https://images.pexels.com/photos/1181298/pexels-photo-1181298.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
    },
    {
        id: "cloud-metrics-dashboard",
        title: "Cloud Resource Monitor",
        category: "DevOps / Front-end",
        description: "Real-time, comprehensive monitoring dashboard for AWS clusters.",
        longDescription: "Developed a stunning, real-time analytics dashboard using Next.js and WebSockets. Seamlessly aggregates metrics from AWS CloudWatch into beautifully animated charts and alerts teams dynamically.",
        techStack: ["Next.js", "TypeScript", "Tailwind CSS", "AWS", "WebSockets"],
        repo: "#",
        demo: "#",
        color: "from-indigo-600/20 to-blue-500/20",
        hoverColor: "group-hover:from-indigo-600/40 group-hover:to-blue-500/40",
        span: "md:col-span-1 md:row-span-2",
        mediaType: "image",
        mediaUrl: "https://images.pexels.com/photos/106344/pexels-photo-106344.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1",
        demoUrl: "https://images.pexels.com/photos/265081/pexels-photo-265081.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
    }
];
