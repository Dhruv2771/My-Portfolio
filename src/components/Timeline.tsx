...
const TIMELINE_DATA = [
  {
    ...
    description: "Completed intensive training in data science workflows, dataset evaluation, and modeling techniques.",
    type: "work",
  },
  {
    year: "2024",
    ...
    description: "Focused on backend development, exploring the Python ecosystem, database integrations, and robust API creation with Django framework.",
    type: "work",
  },
  {
    year: "2022 - 2026",
    title: "B.Tech in Artificial Intelligence and Data Science",
    org: "CVM University (A. D. Patel Institute of Technology)",
    description: "Undergraduate student focusing on Machine Learning, NLP, LLMOps, and Generative AI Development.",
    type: "education",
  },
];
